...
const Footer = () => {
    ...
    return (
        <footer id="shopify-section-footer" className="shopify-section site-footer footer-with-img">
                ...
                <div className="footer-row">
                    <div className="footer-col footer-subscribe-col">
                        <div className="footer-widget">
                            ...
                            <p>Precision sprayers ensure targeted application, minimizing environmental impact while maximizing crop yield and health. Furthermore, irrigation systems utilize sprays to distribute water efficiently.</p>
                        </div>
                    </div>

                    <div className="footer-col footer-link footer-link-1">
                        <div className={`footer-widget footer-ween ${openSection === 'nav' ? 'active' : ''}`}>
                            <h4 onClick={() => toggleSection('nav')}>
                                Navigation :
                                <span className="footer-plus"></span>
                            </h4>
                            <ul className="footer-collapse-content">
                                <li><a href="/">Home</a></li>
                    ...
                    <div className="footer-col footer-link footer-link-1">
                        <div className={`footer-widget footer-ween ${openSection === 'about' ? 'active' : ''}`}>
            ...
            <div className="footer-bottom">
                <div className="container">
                    <div className="footer-wrp">
                        <p>© 2026, <a href="/" title="">Sprays WorkDo</a>, <a href="https://workdo.io/" target="_blank" rel="noreferrer" title="workdo">Powered by WorkDo.io</a></p>
                        <div className="payment-image-wrapper d-flex align-items-center">
