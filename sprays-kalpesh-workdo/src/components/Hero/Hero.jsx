...
const heroProducts = [
  {
    ...
    cartProduct: { id: 101, name: 'Herod Eau De Parfum', brand: 'Rihanna', price: 10.00, image: 'https://sprays-workdo.myshopify.com/cdn/shop/files/1_25130907-77db-42f8-914b-caebe6ddf9ce_600x600.png', weights: ['80ml', '60ml', '50ml'] },
  },
  {
    id: 2,
    badge: 'Popular',
    ...
    cartProduct: { id: 102, name: 'Coco Mademoiselle EDP', brand: 'Chanel', price: 85.00, image: 'https://sprays-workdo.myshopify.com/cdn/shop/files/1_9fb478e8-5bf8-47b2-8632-27e5c0519a52_600x600.png?v=1700112945', weights: ['100ml', '50ml'] },
  },
  {
    id: 3,
    badge: 'Sale',
    ...
    cartProduct: { id: 103, name: 'Miss Dior Blooming', brand: 'Dior', price: 95.00, image: 'https://sprays-workdo.myshopify.com/cdn/shop/files/1_f89b722a-1739-4b59-9ff9-fbc612c7ab3b_600x600.png?v=1700112789', weights: ['75ml', '30ml'] },
  },
];
...
const Hero = () => {
  ...
  const goDown = () => setActiveSlide(prev => Math.min(heroProducts.length - 1, prev + 1));

  // Reset added state when slide changes
  useEffect(() => { setAddedToCart(false); }, [activeSlide]);
  ...
  const p = heroProducts[activeSlide];

  const handleAddToCart = () => {
    addToCart(p.cartProduct, p.weight[0]);
    setAddedToCart(true);
          ...
          <div className="left-side">
            ...
            <div className="hero-btns">
              ...
              <button className="btn-video" onClick={() => setVideoOpen(true)}>
                <span className="play-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 44" width="60" height="60">
            ...
            <div className="service-tags">
              <div className="service-item">
                <div className="service-icon"><img src="https://sprays-workdo.myshopify.com/cdn/shop/files/sev-1.png?v=1700130193" alt="Finished products icon" /></div>
                <div>
              ...
              <div className="service-item">
                <div className="service-icon"><img src="https://sprays-workdo.myshopify.com/cdn/shop/files/sev-2.png?v=1700130194" alt="Promotions icon" /></div>
                <div>
              ...
              <div className="service-item">
                <div className="service-icon"><img src="https://sprays-workdo.myshopify.com/cdn/shop/files/sev-3.png?v=1700130194" alt="Free shipping icon" /></div>
                <div>
              ...
              <div className="product-card" key={p.id}>
                ...
                <div className="product-info">
                  ...
                  <div className="price-row">
                    ...
                    <button
                      className={`add-to-cart${addedToCart ? ' cart-added' : ''}`}
