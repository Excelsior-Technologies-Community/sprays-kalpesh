...
const navConfig = {
  ...
  mainNav: [
    ...
    },
    {
      ...
      items: [
        { label: "Signature Perfumes", image: "https://sprays-workdo.myshopify.com/cdn/shop/files/bottle-that-has-word-message-it_1.jpg?v=1737625387" },
        { label: "Unisex Perfume", image: "https://sprays-workdo.myshopify.com/cdn/shop/files/aloe-vera-leaves-with-beauty-cream-bottle_1.jpg?v=1737625387" },
        { label: "Men's Fragrances", image: "https://sprays-workdo.myshopify.com/cdn/shop/files/skin-care-product-grass_1.jpg?v=1737625387" },
        { label: "Universal Fragrances", image: "https://sprays-workdo.myshopify.com/cdn/shop/files/front-view-argan-product-assortment_1.jpg?v=1737625387" }
      ]
    },
    {
      id: "blog",
...
const Navbar = () => {
  ...
  const toggleMobileMenu = () => {
    ...
    setOpenSubmenuId(null); // Reset when closing
  };
                    ...
                    <div className="mobile-submenu-panel">
                      ...
                      {menu.type === 'mega-collections' && (
                        <div className="mobile-sub-collections">
                          {menu.items.map((item, iIdx) => (
                            <div key={iIdx} className="mobile-coll-item">
                              <img src={item.image} alt={item.label} />
                              <span>{item.label}</span>
                            </div>
                          ))}
